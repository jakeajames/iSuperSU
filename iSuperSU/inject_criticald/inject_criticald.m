...
int main(int argc, char* argv[]) {
    ...
    [messageCenter sendMessageAndReceiveReplyName:@"platformize" userInfo:[NSDictionary dictionaryWithObject:[NSString stringWithFormat:@"%d", pid] forKey:@"pid"]];
    
    [messageCenter sendMessageAndReceiveReplyName:@"setcsflags" userInfo:[NSDictionary dictionaryWithObject:[NSString stringWithFormat:@"%d", pid] forKey:@"pid"]];
    ...
    [dict setValue:[NSString stringWithFormat:@"%d", pid] forKey:@"pid"];
    
    [messageCenter sendMessageAndReceiveReplyName:@"entitle" userInfo:dict];
    
    [dict setValue:@"get-task-allow" forKey:@"ent"]; //entitlement name
    [dict setValue:@"true" forKey:@"value"]; //true or false
